    ...
    return (
        ...
        justify-centre pt-40 2xl:pt-20 px-4'>
             ...
             font-bold justify-center text-center'><p>
                        Welcome to Swaad Seeker, your ultimate destination for culinary inspiration and gastronomic delight.
                        <br /> At Swaad Seeker, we believe that cooking is not just about sustenance—it's an art form, a passion, and a way of life.
                    </p></h1>

                <p className='text-sm mt-5 text-centre
                    text-purple-500 bg-[#00000090] px-6 py-4
                    rounded-full justify-center text-center'>Our mission is simple: to empower home cooks and food enthusiasts alike with a treasure trove of delicious recipes, expert tips, and creative ideas to elevate every mealtime experience. Whether you're a seasoned chef or a kitchen novice, Swaad Seeker is your go-to resource for culinary adventures.
